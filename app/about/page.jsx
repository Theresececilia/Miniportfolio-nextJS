    ...
    <>
      <div className={styles.aboutContainer}>
        <div className={styles.infoContainer}>
          ...
          <p>
            Hi, I am Therese! I am a Frontend Developer under the name of Luna
            Grace. Currently located in Stockholm, Sweden.
            <br />
            In January 2022 I found codecademy. Outside of my full-time job I
            studied <span className={listClasses}>Math</span> along with
            frontend developer essentials. Since Mars 2022 I haveve created art
            with a javascript libary called{' '}
            <span className={listClasses}>p5.js</span>.
            <br />
            In September 2022 I joined the Frontend developer program on{' '}
            <a
